...
namespace adobe_color_picker_clone_part_1
{
	...
	public class frmColorPicker : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // pictureBox1
            // 
            this.pictureBox1.Image = global::IssueTimeTracker.Properties.Resources.black_color_dropper_512_2_;
        ...
        {
            using (ColorDropper colorPicker = new ColorDropper())
            {
                colorPicker.ShowDialog();
                if (colorPicker.DialogResult == DialogResult.OK)
                    PrimaryColor = colorPicker.PickedColor();
            }
        }
    }
}
