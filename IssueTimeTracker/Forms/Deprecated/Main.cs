...
namespace IssueTimeTracker
{
    ...
    public partial class Main : Form
    {
        ...
        private void SetGlobalTimer()
        {
            ...
            if (GlobalTimerHelper.MillisecondChanged)
            {
                ...
                if (MainWatch.Elapsed.TotalMilliseconds >= 1)
                    Global_Millisecond.ForeColor = Color.Black;
                else
                    Global_Millisecond.ForeColor = Color.Gray;
            }
            ...
            if (GlobalTimerHelper.SecondChanged)
            {
                ...
                {
                    Global_Second.ForeColor = Color.Black;
                    Global_SecondPeriod.ForeColor = Color.Black;
                }
                else
                {
                    Global_Second.ForeColor = Color.Gray;
                    Global_SecondPeriod.ForeColor = Color.Gray;
                }
            }
            ...
            if (GlobalTimerHelper.MinuteChanged)
            {
                ...
                {
                    Global_Minute.ForeColor = Color.Black;
                    Global_MinuteColon.ForeColor = Color.Black;
                }
                else
                {
                    Global_Minute.ForeColor = Color.Gray;
                    Global_MinuteColon.ForeColor = Color.Gray;
                }
            }
            ...
            if (GlobalTimerHelper.HourChanged)
            {
                ...
                {
                    Global_Hour.ForeColor = Color.Black;
                    Global_HourColon.ForeColor = Color.Black;
                }
                else
                {
                    Global_Hour.ForeColor = Color.Gray;
                    Global_HourColon.ForeColor = Color.Gray;
                }
            }
        }
        ...
        private void SetTaskTimer()
        {
            ...
            if (TaskWatch.Elapsed.TotalMilliseconds >= 1)
                Task_Millisecond.ForeColor = Color.Black;
            else
                Task_Millisecond.ForeColor = Color.Gray;

            Task_Second.Text = (TaskWatch.Elapsed.Seconds < 10 ? "0" : "") + (TaskWatch.Elapsed.Seconds).ToString();
            if (TaskWatch.Elapsed.TotalSeconds >= 1)
            {
                Task_Second.ForeColor = Color.Black;
                Task_SecondPeriod.ForeColor = Color.Black;
            }
            else
            {
                Task_Second.ForeColor = Color.Gray;
                Task_SecondPeriod.ForeColor = Color.Gray;
            }

            Task_Minute.Text = (TaskWatch.Elapsed.Minutes < 10 ? "0" : "") + (TaskWatch.Elapsed.Minutes).ToString();
            if (TaskWatch.Elapsed.TotalMinutes >= 1)
            {
                Task_Minute.ForeColor = Color.Black;
                Task_MinuteColon.ForeColor = Color.Black;
            }
            else
            {
                Task_Minute.ForeColor = Color.Gray;
                Task_MinuteColon.ForeColor = Color.Gray;
            }
            ...
            {
                Task_Hour.ForeColor = Color.Black;
                Task_HourColon.ForeColor = Color.Black;
            }
            else
            {
                Task_Hour.ForeColor = Color.Gray;
                Task_HourColon.ForeColor = Color.Gray;
            }
        }
        ...
        public void ApplyTheme(Theme theme)
        {
            ...
            List<Control> all = this.GetAll(this, typeof(Label)).ToList();
            all.AddRange(this.GetAll(this, typeof(Button)).ToList());
    ...
    /// <summary>
    /// Used to help make the timers flash less
    /// </summary>
